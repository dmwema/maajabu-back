                                    ...
                                    <tbody>
                                        @foreach ($services as $service)
                                            ...
                                            <tr>
                                                ...
                                                <td><img style="width: 100px; height: 100px;" src="{{ Storage::url($service->img_url) }}" alt=""/> </td>
                                                <td>{{(isset($service->tarif))?$service->tarif->name:'Pas de tarif' }}</td>
                                                <td>
                ...
                <form method="POST" action="{{ route('service.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="tarif" class="form-label" required>Tarif</label>
                                <select class="form-select" name="tarif" id="tarif">

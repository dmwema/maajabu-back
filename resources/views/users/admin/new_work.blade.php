                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="engineer" id="engineer" class="form-select">
                                        @foreach ($engineers as $ir)
                                            <option value="{{ $ir->name }}">{{ $ir->name }} ({{ $ir->phone }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="artits" id="artits" class="form-select">
                                        @foreach ($artists as $art)
                                            <option value="{{ old('artist') }}">{{ $art->name }}
                                                ({{ $art->phone }})
                                            </option>
                                        @endforeach
                                    </select>

            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                        ...
                        <div class="user-profile d-flex no-block dropdown m-t-20">
                            ...
                            <div class="user-content hide-menu m-l-10">
                                <a href="#" class="" id="Userdd" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <h5 class="m-b-0 user-name font-medium">{{ $admin->name }} <i
                                            class="fa fa-angle-down"></i>
                                    </h5>
                                    <span class="op-5 user-email">{{ $admin->email }}</span>
                                </a>
                    ...
                    <li class="sidebar-item {{ $active == 'home' ? 'selected' : '' }}"> <a
                            class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.home') }}"
